...
import { registerProposalPdfRoutes } from "../routes/proposalPdfRoutes";
...
export async function startServer() {
  ...
  const proposalPdfController = createProposalPdfController(deps);
  ...
  registerProposalPdfRoutes(app, proposalPdfController);
