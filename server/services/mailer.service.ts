...
export async function sendBankTransferReservationEmail(params: {
  ...
  const supportLine = translate(
    lang,
    "emails.bankTransfer.supportLine",
    "Para cualquier consulta sobre esta reserva, escribe a {{supportEmail}}.",
    { supportEmail: bankSupportEmail },
  );
