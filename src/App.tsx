...
import { ClientInstallationsMap } from "./components/shared/ClientInstallationsMap";
import {
 ...
 * Debe coincidir con INSTALLATION_SEARCH_RADIUS_METERS del servidor.
...
/**
 * Devuelve la potencia fija SOLO si la instalación está configurada con
 * calculo_estudios === "fijo". Si es "segun_factura" (o cualquier otro
 * valor), devuelve null para que la potencia se calcule a partir del
...
useEffect(() => {
  ...
  const timer = window.setTimeout(() => {
    ...
    const result = calculateEnergyStudy({
      ...
      modality: normalizeInstallationModalidad(selectedInstallation.modalidad),
      selfConsumptionRatio: normalizeSelfConsumption(
                              ...
                              render={({ field }) => (
                                <PlacesAutocompleteInput
                                  ...
                                  onPlaceSelected={(place) => {
                                    // Autorrellenamos el campo con la
                                    // dirección canónica de Google y guardamos
                                    // las coords para saltarnos la llamada a
                                    // /api/geocode-address en el siguiente paso.
                      ...
                      {clientCoords ? (
                        <ClientInstallationsMap
                          ...
                          onSelectInstallation={(id) => {
                            ...
                            if (match) handleInstallationSelect(match);
                          }}
                        />
                      ) : (
