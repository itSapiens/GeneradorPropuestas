...
import { normalizeInstallationModalidad } from "@/src/entities/proposal/domain/proposal.rules";
import {
...
} from "@/src/features/proposal-flow/lib/proposalCalculation";
import { getDefaultProposalMode } from "@/src/entities/proposal/domain/proposal.rules";
...
export function useProposalCalculationEffect({
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      ...
      console.log(`  invoiceTotalAmountEur:          ${validatedData.invoiceTotalAmountEur ?? invoiceTotalAmountEur ?? "(no extraído)"}`);
