...
const SYSTEM_INSTRUCTION = [
  ...
  "",
  "CONSUMOS (kWh):",
  "- invoice_data.currentInvoiceConsumptionKwh: consumo total facturado EN ESTA factura (el que aparece como 'Consumo total de esta factura', 'Su consumo en el periodo facturado ha sido', 'Energía consumida', etc.).",
  "- invoice_data.consumptionKwh: mismo valor que currentInvoiceConsumptionKwh (se mantienen los dos por compatibilidad).",
  "- invoice_data.averageMonthlyConsumptionKwh: déjalo en null. El servidor lo recalcula a partir del consumo facturado y los días del periodo.",
  "- invoice_data.periods.Pn: consumo en kWh por cada periodo tarifario. Para 2TD: P1=punta, P2=llano, P3=valle, P4..P6=null.",
  "- invoice_data.postcodeAverageConsumptionKwh: consumo medio del código postal SOLO si aparece explícitamente en la factura.",
  "",
  "PRECIOS:",
  "- invoice_data.periodPricesEurPerKwh.Pn: precio en €/kWh por periodo SOLO si la factura lo muestra explícitamente. Si solo hay un precio medio, deja todos en null.",
  "- invoice_data.invoiceVariableEnergyAmountEur: importe total de 'Por energía consumida' / 'Facturación por energía consumida (TÉRMINO VARIABLE)' en euros.",
  "",
  "POTENCIA CONTRATADA:",
  ...
  "- extraction.warnings: array con avisos breves relevantes (OCR dudoso, campos contradictorios, factura no eléctrica, etc.).",
