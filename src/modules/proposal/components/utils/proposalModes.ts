...
import { ApiInstallation, ProposalMode } from "../types/proposal.types";
import { BillDataSchema } from "@/src/lib/validators";
import { optionalNumberField } from "./proposalNumbers";
import z from "zod";
